...
namespace Kinematics {
	...
	public:
		...
		Scope<ClientSocket>& GetClient() { return m_ClientSocket; }
		Scope<ServerSocket>& GetServer() { return m_ServerSocket; }
	...
	protected:
		Scope<ServerSocket> m_ServerSocket;
		Scope<ClientSocket> m_ClientSocket;
