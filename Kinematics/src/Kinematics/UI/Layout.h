...
namespace Kinematics
{
	...
	namespace UI {
		...
		public:
			...
			virtual glm::vec2 GetPreferredSize(const UIElementInterface* element) const = 0;
		...
		public:
			...
			virtual glm::vec2 GetPreferredSize(const UIElementInterface* element) const override;
